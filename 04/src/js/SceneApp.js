...
class SceneApp extends Scene {
	...
	_initViews() {
		...
		this._fboBlur  	= new alfrid.FrameBuffer(window.innerWidth, window.innerHeight, o);
		this._fboRender  	= new alfrid.FrameBuffer(window.innerWidth, window.innerHeight, o);
    ...
    this.speed.y = this.mouse.y - this.lastPos.y
		...
		GL.viewport(0, 0, GL.height / 4, GL.height / 4);
