...
class FrameBuffer {
  ...
  _initTextures () {
    ...
    if (GL.webgl2) {
      this.glDepthTexture = this._createTexture(gl.DEPTH_COMPONENT16, gl.UNSIGNED_SHORT, gl.DEPTH_COMPONENT, { minFilter: GL.NEAREST, magFilter: GL.NEAREST, mipmap: false })
    } else {
